...
SolverParam::SolverParam()
{
    ...
    cv::FileStorage fs("/home/night/Documents/code/yolo7/YOLO-of-RoboMaster-Keypoints-Detection-2023-3.0/C++_inference_openvino_kpt/Settings.xml", cv::FileStorage::READ);
